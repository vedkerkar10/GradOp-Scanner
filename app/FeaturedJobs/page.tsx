...
const JobResults: React.FC = () => {
  ...
  return (
    <>
      <Navbar />
      <div className="w-full h-screen flex flex-col md:flex-row items-center px-4 md:px-12 text-black bg-white">
        {/* Left Section: Existing Job Listings */}
          ...
          {loading ? (
            ...
            <>
              ...
              <div className="flex flex-row items-center justify-center gap-8 mt-4">
                <Link href={"/Explore"}>
                  <button
                    className="flex justify-center items-center gap-2 w-full h-full p-4 cursor-pointer rounded-md shadow-2xl text-white font-semibold bg-gradient-to-r from-[#49AA4D] via-[#90a955] to-[#49AA4D] hover:shadow-xl hover:shadow-green-500 hover:scale-105 duration-300 hover:from-[#047857] hover:to-[#14b8a6]"
                  >
