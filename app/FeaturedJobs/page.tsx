...
const JobResults: React.FC = () => {
  ...
  return (
    <>
    <Navbar />
    <div className="w-full flex flex-col justify-center items-start px-12 text-black bg-white">
      <span className="text-black text-2xl mt-8 font-bold">Featured Jobs</span>
